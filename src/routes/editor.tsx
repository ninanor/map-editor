...
export const Route = createFileRoute('/editor')({
  ...
  loader: ({ context: { queryClient } }) => {
    return queryClient.ensureQueryData(configQueryOptions(EDITOR_CONFIG_URL));
  },
...
function RootComponent() {
  ...
  const { isLoading, data: config } = useSuspenseQuery(configQueryOptions(EDITOR_CONFIG_URL));
